...
.EXAMPLE
    & .\AppInstaller-App-Management-IntuneWin32.Template.ps1
.Example
    & .\AppInstaller-App-Management-IntuneWin32.Template.ps1 -Mode Enable
.Example
    & .\AppInstaller-App-Management-IntuneWin32.Template.ps1 -Mode Disable
.Example
    & .\AppInstaller-App-Management-IntuneWin32.Template.ps1 -Mode Detect
#>
...
$SCRIPT_NAME = ".Intune.Win32App.AppInstaller-$($APP_NAME.Replace(' ',''))"
