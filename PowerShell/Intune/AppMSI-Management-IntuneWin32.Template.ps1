<#
# #################################################################################################################### #
# Filename: \PowerShell\Intune\AppMSI-Management-IntuneWin32.Template.ps1                                              #
# Repository: Code-Templates                                                                                           #
# Created Date: Monday, February 10th 2025, 12:39:57 PM                                                                #
# Last Modified: Monday, February 10th 2025, 12:53:16 PM                                                               #
...
.DESCRIPTION
    App (MSI) management script for installing, uninstalling & detecting {App}
.EXAMPLE
    & .\AppMSI-Management-IntuneWin32.Template.ps1
.Example
    & .\AppMSI-Management-IntuneWin32.Template.ps1 -Mode Install
.Example
    & .\AppMSI-Management-IntuneWin32.Template.ps1 -Mode Uninstall
.Example
    & .\AppMSI-Management-IntuneWin32.Template.ps1 -Mode Detect
#>
...
$MSI_FILE = "" # Filename of the installer executable
$MSI_INSTALL_ARGUMENTS = "" # Arguments for the installer executable to enable silent installation & other features. Do not enter /qn, this is already applied.
$MSI_UNINSTALL_ARGUMENTS = "" # Arguments for the uninstaller executable to enable silent uninstallation. Do not enter /qn, this is already applied.
...
$INSTALLER_PATH = "$env:windir\System32"
$INSTALLER_EXECUTABLE = "msiexec.exe"
$INSTALLER_ARGUMENTS = "/i ""$PSScriptRoot\$MSI_FILE"" /qn $MSI_INSTALL_ARGUMENTS"
$UNINSTALLER_PATH = $INSTALLER_PATH
$UNINSTALLER_EXECUTABLE = $INSTALLER_EXECUTABLE
$UNINSTALLER_ARGUMENTS = "/x ""$PSScriptRoot\$MSI_FILE"" /qn $MSI_UNINSTALL_ARGUMENTS"
